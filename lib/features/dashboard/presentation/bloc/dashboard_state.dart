...
class DashboardSummaryLoaded extends DashboardStates {
  ...
  @override
  List<Object?> get props => [totalBalance, totalIncome, totalExpenses, currentFilter];
}
...
////////////////////////////////////////////////////////////////////////////////
class PaginationLoading extends DashboardStates {}
class PaginationLoaded extends DashboardStates {
  final List<ExpenseEntity> items;
  final bool hasMore;
  final bool isLoadingMore;
  const PaginationLoaded(this.items, {this.hasMore = true, this.isLoadingMore = false});
}
class PaginationError extends DashboardStates {
